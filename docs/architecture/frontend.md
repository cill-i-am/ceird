...
- `features/jobs-workspace/jobs-workspace-live-detail.ts`, where the
  ...
  collaborators, visits, record-local activity, product-safe actors, and
  comments-ready counts. Detail open/close is route search state and uses the
  shared hotkey layer for keyboard open, close, and focus restoration.
