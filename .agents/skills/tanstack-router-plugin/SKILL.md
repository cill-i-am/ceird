...
- [tanstack-router-code-splitting](../tanstack-router-code-splitting/SKILL.md) — manual code splitting concepts
- [tanstack-virtual-file-routes](../tanstack-virtual-file-routes/SKILL.md) — programmatic route trees
