...
- [tanstack-start-server-routes](../tanstack-start-server-routes/SKILL.md) — API endpoints for sitemaps, robots.txt
- [tanstack-start-execution-model](../tanstack-start-execution-model/SKILL.md) — SSR affects where code runs
