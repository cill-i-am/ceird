...
> **CRITICAL**: TanStack Router is CLIENT-FIRST. Loaders run on the client by default. With SSR enabled, loaders run on BOTH client AND server. They are NOT server-only like Remix/Next.js loaders. See [tanstack-router-data-loading](../tanstack-router-data-loading/SKILL.md).
...
See [tanstack-router-data-loading](../tanstack-router-data-loading/SKILL.md) for loader fundamentals.

## Cross-References

- [tanstack-router-data-loading](../tanstack-router-data-loading/SKILL.md) — SSR changes where loaders execute
- TanStack Query SSR dehydration and hydration patterns pair well with this skill
