...
- [tanstack-start-server-functions](../tanstack-start-server-functions/SKILL.md) — what middleware wraps
- [tanstack-start-server-routes](../tanstack-start-server-routes/SKILL.md) — middleware on API endpoints
