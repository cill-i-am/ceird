---
name: to-prd
description: Turn conversation context, research, or a rough feature idea into a Linear Project/PRD using this repo's Linear workflow. Use when the user wants a PRD, product spec, Linear project, initiative/project framing, or a source-of-truth product brief for later issue slicing.
---
...
- If the PRD is ready for slicing, set or recommend the state that maps to
  `ready-for-agent` or `needs-triage` according to `docs/agents/triage-states.md`.
