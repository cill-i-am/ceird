...
- Prefer moving shared contracts, DTO schemas, branded IDs, service-binding
  client helpers, and cross-cutting runtime-neutral helpers into packages
  instead of duplicating them in apps.
- Product repositories, authorization policy, action execution, audit writers,
  Drizzle schema/migrations, and domain service implementations belong in
  `apps/domain`, not reusable packages.
